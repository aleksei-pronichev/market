...
public class ProductsSpecifications {
    ...
    public static Specification<Product> categoryLike(String titlePart) {
        return (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.like(root.get("category").get("title"), String.format("%%%s%%", titlePart));
    }
}
